...
src/test/java/.../CheckerSelfTest        gate (i): 6 synthetic histories, pinned verdicts (needs PORCUPINE_BIN)
...
# GATE (i): checker self-test (6 synthetic histories through the real recorder->checker)
