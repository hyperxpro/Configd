 ...
 * consumes from the real-binary harness (adversarial-sim-design §6;
 ...
 * {@code :info} (ack ≠ commit, RR-004) — it is promoted to "happened" only when a
 ...
 * nothing is {@code :ok} of ⊥. The real-time backbone is the simulated clock, which
...
final class HistoryRecorder {
     ...
     * observed token; a not-found is {@code :ok} of ⊥ (still a real-time fact).
     */
    ...
    void finish(long endTs) {
        // No-op for now; kept as the §6 capture point should a closing marker be
