 ...
 * SERVER-SIDE per-request allocation that Phase R could not measure (its {@code -prof gc} was
 ...
 *       client allocation (the JDK {@code HttpClient}, which Phase R flagged as plausibly the
 ...
 * in place, Phase R's finding; there is no into-buffer lever as the codecs had) and the
