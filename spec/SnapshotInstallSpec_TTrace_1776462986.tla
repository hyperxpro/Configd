---- MODULE SnapshotInstallSpec_TTrace_1776462986 ----
...
_inv ==
    ~(
        ...
        /\
        currentTerm = ((n1 :> 2 @@ n2 :> 1 @@ n3 :> 0))
        /\
        log = ((n1 :> <<>> @@ n2 :> <<>> @@ n3 :> <<>>))
        /\
        state = ((n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"))
        /\
        snapshot = ((n1 :> [index |-> 1, term |-> 2] @@ n2 :> [index |-> 1, term |-> 1] @@ n3 :> [index |-> 0, term |-> 0]))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SnapshotInstallSpec_TTrace_1776462986.json", _TETrace)
...
\*
\*trace == IODeserialize("SnapshotInstallSpec_TTrace_1776462986.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 0 @@ n3 :> 0),log |-> (n1 :> <<>> @@ n2 :> <<>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "follower" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 0 @@ n2 :> 0 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<>> @@ n2 :> <<>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 0 @@ n2 :> 0 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<[term |-> 2]>> @@ n2 :> <<>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 0 @@ n2 :> 0 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<[term |-> 2]>> @@ n2 :> <<[term |-> 1]>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 0 @@ n2 :> 0 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<[term |-> 2]>> @@ n2 :> <<[term |-> 1]>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 1 @@ n2 :> 0 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<[term |-> 2]>> @@ n2 :> <<[term |-> 1]>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 0, term |-> 0] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 1 @@ n2 :> 1 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<>> @@ n2 :> <<[term |-> 1]>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 1, term |-> 2] @@ n2 :> [index |-> 0, term |-> 0] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 1 @@ n2 :> 1 @@ n3 :> 0),inflight |-> {}]),
    ([currentTerm |-> (n1 :> 2 @@ n2 :> 1 @@ n3 :> 0),log |-> (n1 :> <<>> @@ n2 :> <<>> @@ n3 :> <<>>),state |-> (n1 :> "leader" @@ n2 :> "leader" @@ n3 :> "follower"),snapshot |-> (n1 :> [index |-> 1, term |-> 2] @@ n2 :> [index |-> 1, term |-> 1] @@ n3 :> [index |-> 0, term |-> 0]),commitIndex |-> (n1 :> 1 @@ n2 :> 1 @@ n3 :> 0),inflight |-> {}])
    >>
----
...
---- CONFIG SnapshotInstallSpec_TTrace_1776462986 ----
CONSTANTS
    Nodes = { n1 , n2 , n3 }
    MaxTerm = 3
    MaxIndex = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Apr 17 21:56:28 UTC 2026