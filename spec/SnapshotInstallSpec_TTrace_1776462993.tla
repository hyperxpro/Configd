---- MODULE SnapshotInstallSpec_TTrace_1776462993 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SnapshotInstallSpec_TTrace_1776462993.json", _TETrace)
...
\*
\*trace == IODeserialize("SnapshotInstallSpec_TTrace_1776462993.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SnapshotInstallSpec_TTrace_1776462993 ----
CONSTANTS
    Nodes = { n1 , n2 , n3 }
    MaxTerm = 3
    MaxIndex = 4
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Apr 17 21:56:35 UTC 2026