 ...
 *                       overrides it with the certificate DN, so it is diagnostic only.
 * @param acceptFiltered opt into the server-side-filtered fan-out (wire version {@code 0x03}) for a
