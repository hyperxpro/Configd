...
The operator's production-readiness review (see `docs/readiness/`) reads
the most recent result for each drill. A runbook is GREEN only when:
...
Otherwise the review records the drill as YELLOW with the actual
