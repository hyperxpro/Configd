...
/**
 * The watch resume position: a <b>per-shard cursor vector</b> (RFC §2 W3-1 / W3-5). An
 * ordered list of {@code (gid, S)} components, where {@code gid} is a shard group id
 * (a {@code uint32} compared and ordered <b>UNSIGNED</b>) and {@code S} is the
 * applied-mutation sequence of that shard the client has already processed (ADR-0033).
 *
 ...
 *
 * <p>The wire encoding (shared with §1's {@code list} continuation cursor, W3-5) is
