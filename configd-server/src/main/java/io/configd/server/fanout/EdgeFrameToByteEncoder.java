 ...
 *
 * <p><b>Per-connection wire version (W1-3 / §6a).</b> The frame is stamped with the connection's
 ...
 * reused {@code NOTIFY} on a {@code full_chain_verify} watch is stamped {@code 0x02} too (W5-2). The
...
final class EdgeFrameToByteEncoder extends MessageToByteEncoder<EdgeFrame> {
    ...
    /** Supplies the connection's current negotiated outbound edge wire version (W1-3). */
    @FunctionalInterface
