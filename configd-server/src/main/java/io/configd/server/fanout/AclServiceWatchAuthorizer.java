 ...
 * {@code configd-control-plane-api} in the reactor and so cannot see {@code AclService} directly;
 * {@code ConfigdServer} constructs this adapter and threads it into the
 ...
 *
 * <h2>The authorization branch</h2>
...
public final class AclServiceWatchAuthorizer implements WatchAuthorizer {
     ...
     * against the degenerate whole-target {@code READ} cover over the root prefix
