...
/**
 * The full admin / control-plane S7 contract on the JDK {@link HttpApiServer} transport — the
 * incumbent transport, re-proven through the shared {@link AbstractAdminApiServerContract} after the
 * decision logic was extracted into {@link AdminApiHandler} (ADR-0043 M2). This is the baseline the
