 ...
 * version that triggers bounded watch revocation. It is {@link Long#MIN_VALUE} for the EMPTY default
 * (production, no {@code _acl/} keys -> never changes -> no re-auth cost), advances on each publish,
 * and never regresses on a stale versioned publish.
 */
