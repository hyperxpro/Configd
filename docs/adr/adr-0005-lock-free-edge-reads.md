...
- Total read: **< 50ns** (50,000x under the 1ms target)
- At p999 with GC jitter (ZGC): ~1-5us (1000x under 5ms target)

## Rejected Alternatives
- **ConcurrentHashMap:** Allocates during reads (iterator). No immutable snapshots. No structural sharing.
- **Copy-on-write HashMap (Collections.unmodifiableMap):** Full copy on every update. At 10^6 keys x 1KB = 1 GB copied per update - catastrophic.
