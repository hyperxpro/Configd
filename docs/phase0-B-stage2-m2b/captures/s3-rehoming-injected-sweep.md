...
owner isolation across rehomes (zero fires), in-node safety (the throwing checker), liveness/non-vacuity
(every group's commitIndex GROWS past baseline), no deadlock/livelock (completes in time).
