...
/**
 * The requested read consistency. {@link #STALE} (the default) is a bounded-staleness local read;
 * {@link #LINEARIZABLE} opts into a leader-confirmed read via the exact query literal
 * {@code consistency=linearizable}.
 *
 * <p><b>The loose-substring trap.</b> The server matches linearizable with
