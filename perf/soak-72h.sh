#!/usr/bin/env bash
# 72-hour soak harness: 5-node cluster, steady-state workload.
# Asserts: commit p99<150ms, edge-read p99<1ms, propagation p99<500ms, RSS growth<10%, no leader churn post-warmup.
