 ...
 * {@link InboundMessage} per complete frame, preserving the JDK reader's discipline verbatim (M4 /
 * DR-N16):
 *
 * <ul>
 ...
 *       failure is a desync → {@link CorruptedFrameException} → close. (A <em>handler</em> throw, by
 *       contrast, is caught downstream and does <em>not</em> close — the framing layer is intact.)</li>
 * </ul>
 *
